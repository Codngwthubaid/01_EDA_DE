...
- Create a ranking column that combines both demand count and medium salary to identify the most valuable skills.
- Focus only on remote Data Engineer positions with specified annual salaries.
- Why ?
-- This approach highlights skills that balance market demand and financial reward. It weights core skills appropriately, rather than letting rare, outliner skills distort the results.
*/
...
SELECT  
    ...
    ROUND(COUNT(jpf.*),1) AS demand_count,
...
/*
Here is a breakdown of mowst optimal skills for Data Engineers, based on both both high demand and high salaries :

Top skills by optimal score:
- Terraform leads the list with a $184k median salary with 193 postings, resulting the highest in the optimal score.
- Python and SQL dominate demand (over 1100 postings each) with strong median salaries of $135k.
- AWS (783 postings with $137k median), Spark (503 postings with $140K), and Airflow (386 postings with $150k median)
- Kafka offers high compensation ($145k with high demand 292 postings)
- Tools like Snowflake, Azure and Databricks each have 250-475 postings with range of $128k-$135k.
