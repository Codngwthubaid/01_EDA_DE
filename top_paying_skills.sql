...
- Include skill frequent to identify both salary and demand
- Why ?
-- It helps better to identify which skills command the highest compensation while also showing how common those skills are, providing a more complete picture for skill development
*/

SELECT 
    sd.skills AS skills,
    ROUND(MEDIAN(jpf.salary_year_avg),2) AS medium_salary,
